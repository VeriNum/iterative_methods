...
((F' / INR n + (F' * (INR n -1)/ INR n + 2 * u / u0)) * (1+ u0) +
/ 2 *
  ...
  * apply Rplus_le_compat_r. apply Rmult_le_compat_l.
    ...
    ++ apply Rlt_le. apply Rinv_lt_contravar.
       -- apply Rmult_lt_0_compat.
          apply lt_0_INR; lia. apply Rmult_lt_0_compat.
          apply lt_0_INR; lia. apply x_pow_gt_0. simpl; nra.
       -- assert (INR n = INR n * 1). { nra. } rewrite H2.
          assert (INR n * 1 * (1 + / 2 * / IZR (Z.pow_pos 2 23)) ^ n = 
                  INR n * (1 + / 2 * / IZR (Z.pow_pos 2 23)) ^ n).
          { nra. } rewrite H3. apply Rmult_lt_compat_l. 
          apply lt_0_INR. lia. apply Rlt_pow_R1. simpl; nra.
          lia. 
+ assert ((F' / INR n +
   ...
   * assert (sum_f_R0 (fun i : nat =>
     ...
     ++ rewrite H3.
        ...
        -- apply Rmult_le_pos.
           ...
           ** apply Rlt_le, Rinv_0_lt_compat. apply ratio_gt_0. lia.
                  ...
                  +++ rewrite -/u0.
                    ...
                    --- rewrite sqrt_def .
                       *** unfold nr.
                          ...
                          unfold u, u0; simpl; nra. apply Rmult_le_compat_l.
                    ...
                    unfold dot_prodF, dot_prodR in IHL. 
                     ...
                     +++ apply Rle_trans with 
                       ...
                       *** assert (sum_fixR (prod_fixR (Flist_to_Rlist_pair_abs L)) +
                         ...
                         { nra. } rewrite H7. clear H7.
                         apply Rle_trans with 
                         (((sqrt (F' / (nr * (1 + u0) ^ (n + 1)) - u))^2 * INR (length L)) *
                          (1 + u0) ^ S m + INR (S m) * u * (1 + u0) ^ (S m - 1) +
                            u * ((1 + u0) ^ (S m - 1) - 1) / u0).
                         ++++  apply Rplus_le_compat_r. apply Rplus_le_compat_r. 
                             apply Rmult_le_compat_r.
                             ---- apply Rlt_le, x_pow_gt_0. unfold u0;simpl; nra. 
                             ---- apply (list_sum_pair L (sqrt (F' / (nr * (1 + u0) ^ (n + 1)) - u))).
                                apply sqrt_pos. intros.
                                specialize (H1 (fst a0) (snd a0)).
                                assert (In (fst a0, snd a0) (a :: L)).
                                { simpl. destruct a0. simpl; auto. }
                                specialize (H1 H8). apply H1.
                         ++++ assert (sqrt (F' / (nr * (1 + u0) ^ (n + 1)) - u) ^ 2 = 
                                    (F' / (nr * (1 + u0) ^ (n + 1)) - u)).
                            { assert (forall x:R, x^2 = x * x). { intros. nra. } rewrite H7.
                              apply sqrt_sqrt.
                              apply Rge_le. apply Rge_minus. apply Rle_ge.
                  ...
                  +++ rewrite -/u0.
                    ...
                    --- rewrite sqrt_def .
                       *** unfold nr.
                          ...
                          } rewrite H11. unfold u, u0; simpl; nra.
                       ***  apply Rge_le. apply Rge_minus. apply Rle_ge.
                           apply pow_invert.
                            **** apply Rmult_lt_0_compat. apply lt_0_INR. lia. 
                              apply x_pow_gt_0. unfold u0; simpl; nra.
